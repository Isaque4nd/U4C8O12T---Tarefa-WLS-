...
void ssd1306_draw_rect(ssd1306_t *ssd, uint8_t x, uint8_t y, uint8_t width, uint8_t height, bool value) {
  // Note que aqui interpretamos (x,y) como o canto superior esquerdo
  ssd1306_rect(ssd, y, x, width, height, value, false);
}

void ssd1306_fill_rect(ssd1306_t *ssd, uint8_t x, uint8_t y, uint8_t width, uint8_t height, bool value) {
  ssd1306_rect(ssd, y, x, width, height, value, true);
}
